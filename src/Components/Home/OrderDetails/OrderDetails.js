...
const OrderDetails = () => {
    ...
    return (
        <div id="orderDetails" className="rounded-2 container">
            <h1 className="text-center fw-bold" style={{ color: 'brown' }} >Food Details </h1>
            <div className="row g-4 py-5">
                <div className="col-md-6 text-center">
                    <div className="card border-0 pt-2">
                        <h2 style={{ color: 'brown' }}>{detailsInfo[0].title}</h2>
                ...
                <div className="col-md-6">
                    <div className=" submit-order pt-2 pb-4">
                    <h2 className="text-center" style={{ color: 'brown' }}>Confirm Your Order</h2>
                    <form className="py-5">
                        ...
                        <br />
                        <input style={{ backgroundColor: 'chocolate' }} className='mt-3 py-2 ps-2 fs-5 border-0 rounded-3 fw-bold text-white' type="submit" value="Order Now" />
                    </form>
                    </div>
                </div>
            </div>
